          ...
          <div className="lg:pr-8 lg:pt-4 flex justify-center">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Hello, my name is Nathã Wolff, and I work as a systems developer at Bosch Company.
                When I began my career, I studied front-end and back-end development.
                However, I have a preference for back-end development because I enjoy understanding how things work behind the screens.
              </p>
